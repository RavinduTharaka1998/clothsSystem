...
<head>
    ...
    <!--stylesheet link-->
    <link rel="stylesheet" href="css/addcloth.css">
...
<body>
            ...
            <div class = "rows">
                ...
                <div class = "colum">
                    <div class = "add">
                        <div class = "frm">
                            <h3>Buy Your Cloth..</h3>
                            <br>
                            <form action = "backend/cloth-add-servelet.php" method = "POST">
                                <div class="form-outline mb-4">
                                    <label class="form-label" for="form2Example1">Cloth Id</label>
                                    <input type="text" name = "c_id" value = "<?php echo $c_id ?>" class="form-control" required readonly/>
                                </div>

                                <div class="form-outline mb-4">
                                    <label class="form-label" for="form2Example1">Description</label>
                                    <textarea type="email" name = "description"  class="form-control"  required readonly><?php echo $description ?></textarea>
                                </div>
                            
                            
                                <div class="form-outline mb-4">
                                    <label class="form-label" for="form2Example2">Price</label>
                                    <input type="text" name = "price" value = "<?php echo $price ?>" class="form-control" readonly required/>
                                </div>
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <textarea type="text" name = "address" class="form-control"  onInput="checkcpassword()" required></textarea>
                                </div>

                                <center>
                                <div class = "signup">
                                    <button type="submit" name = "add" class="btn btn-block mb-4 sign">Buy Now!</button>
                                </div>
                                </center>
                            </form>
                        </div>
